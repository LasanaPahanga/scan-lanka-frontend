/** ISO 3166-1 alpha-2 + international dialing code, for phone country-code pickers. */
...
// Sri Lanka first (most requesters are local institutions), then the rest alphabetically
// by country name - covers all UN member states plus a few common territories so
// international/foreign buyers can always find their own code (11 FR-QUOTE-7).
